...
#define AT32_DMA_CHXCTL_DIR	  BIT(4)
#define AT32_DMA_CHXCTL_M2M	  BIT(14)
#define AT32_DMA_INTERRUPT_ERRORS DMA_DTERR_INT
#define AT32_DMA_FLAG_ERRORS	  DMA_FLAG_ERR

#define AT32_DMA_INTF(dma)	  ((dma_type *)(dma + 0x00UL)
#define AT32_DMA_INTC(dma)	  ((dma_type *)(dma + 0x04UL)
#define AT32_DMA_CHCTL(dma, ch)	  ((dma_channel_type *)((dma + 0x08UL) + 0x14UL * (uint32_t)(ch)))
#define AT32_DMA_CHCNT(dma, ch)	  ((dma_channel_type *)((dma + 0x0CUL) + 0x14UL * (uint32_t)(ch)))
#define AT32_DMA_CHPADDR(dma, ch) ((dma_channel_type *)((dma + 0x10UL) + 0x14UL * (uint32_t)(ch)))
#define AT32_DMA_CHMADDR(dma, ch) ((dma_channel_type *)((dma + 0x14UL) + 0x14UL * (uint32_t)(ch)))
...
static const struct dma_driver_api dma_at32_driver_api = {
