...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_AT32F45X_CLOCKS_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_AT32F45X_CLOCKS_H_
...
/* AHB2 peripherals */
#define AT32_CLOCK_AES        AT32_CLOCK_CONFIG(AHB2EN, 4)
#define AT32_CLOCK_TRNG       AT32_CLOCK_CONFIG(AHB2EN, 6)
...
#define AT32_CLOCK_CAN3       AT32_CLOCK_CONFIG(APB1EN, 27)
...
#define AT32_CLOCK_I2S2EXT    AT32_CLOCK_CONFIG(APB2EN, 30)
#define AT32_CLOCK_I2S3EXT    AT32_CLOCK_CONFIG(APB2EN, 31)

/** @} */

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_AT32F45X_CLOCKS_H_ */
