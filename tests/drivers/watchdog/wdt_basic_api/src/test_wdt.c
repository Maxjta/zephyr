...
#elif DT_HAS_COMPAT_STATUS_OKAY(at_at32_wdt)
#define WDT_NODE DT_INST(0, at_at32_wdt)
#elif DT_HAS_COMPAT_STATUS_OKAY(at_at32_wwdt)
#define WDT_NODE DT_INST(0, at_at32_wwdt)
